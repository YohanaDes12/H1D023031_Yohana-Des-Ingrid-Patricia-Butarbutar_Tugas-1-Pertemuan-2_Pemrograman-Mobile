...
class BookAdapter(private var books: List<BookDoc>) :
    ...
    inner class BookViewHolder(val binding: ListBukuBinding) : // Perlu ListBukuBinding di sini
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookViewHolder {
        val binding = ListBukuBinding.inflate(LayoutInflater.from(parent.context), parent, false) // Perlu ListBukuBinding di sini
